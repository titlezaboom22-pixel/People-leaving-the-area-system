// ตั้ง 01754 ณัฐพล กว้างเคน เป็น HEAD (TBKK PRODUCTION SYSTEM)
...
await setDoc(doc(db, 'artifacts', appId, 'public', 'data', 'users', '01754'), {
  role: 'HOST',
  roleType: 'HEAD',
}, { merge: true });
console.log('✓ ตั้ง 01754 ณัฐพล กว้างเคน เป็น HEAD แล้ว (TBKK PRODUCTION SYSTEM)');
process.exit(0);
