/**
 * One-off: เพิ่มหัวหน้า EEE คนที่ 2 (Kiranapat) สำหรับทดสอบ ApproverPicker
 *   รัน: node scripts/add-head-eee-02.js
 */
...
const user = {
  id: 'HEAD-EEE-02',
  displayName: 'Kiranapat (หัวหน้า EEE)',
  role: 'HOST',
  roleType: 'HEAD',
  department: 'EEE (Employee Experience Engagement)',
  email: 'kiranapat_a@tbkk.co.th',
  active: true,
  status: 'available',
