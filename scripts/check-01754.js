...
const ref = doc(db, 'artifacts', appId, 'public', 'data', 'users', '01754');
const snap = await getDoc(ref);
if (!snap.exists()) console.log('❌ ไม่พบ 01754');
else {
  const d = snap.data();
  console.log('=== 01754 ปัจจุบัน ===');
  ...
  if (d.roleType !== 'HEAD' || d.role !== 'HOST') {
